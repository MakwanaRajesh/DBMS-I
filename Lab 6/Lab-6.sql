...
SELECT UPPER('GUJJU') , LOWER('GUJJU')

--3. Display first three characters of your name.
SELECT LEFT('GUJJU' , 3)

--4. Display 3rd to 10th character of your name.
SELECT SUBSTRING('GUJJU FROM GUJARAT' ,3,10 )
...
SELECT CONVERT(decimal ,'1234.56' ,2)
...
SELECT SPACE(10)+'GUJJU'

--14. Combine two strings using + sign as well as CONCAT ().
SELECT CONCAT('GUJJU','GUJARATI')
SELECT 'GUJJU'+'GUJARATI'

--15. Find reverse of “Darshan”.
SELECT REVERSE('DARSHAN')

--16. Repeat your name 3 times.
SELECT REPLICATE('GUJJU',3)
...
SELECT GETDATE() AS [TODAY DATE] --'TODAY DATE'
